...
/>
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button onClick={() => setModalOpen(true)} className={`flex items-center gap-1 sm:gap-1 px-1 sm:px-2 py-1 sm:py-1 rounded-md text-xs font-mono font-bold tracking-widest transition-all whitespace-nowrap ${user ? 'border border-lime-400/40 text-lime-400 hover:bg-lime-400/10' : 'bg-foreground text-background hover:opacity-90'}`}>
